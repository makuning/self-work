...
void CreateStringMap()
{
	...
	g_smModelToName.SetString("models/w_models/weapons/w_eq_incendiary_ammopack.mdl", "燃烧升级包！");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_explosive_ammopack.mdl", "爆炸升级包！");
	g_smModelToName.SetString("models/props/terror/ammo_stack.mdl", "弹药！");
	g_smModelToName.SetString("models/props_unique/spawn_apartment/coffeeammo.mdl", "弹药！");
	g_smModelToName.SetString("models/props/de_prodigy/ammo_can_02.mdl", "弹药！");
	...
	g_smModelToName.SetString("models/w_models/weapons/w_desert_eagle.mdl", "马格南手枪！");
	g_smModelToName.SetString("models/w_models/weapons/w_shotgun.mdl", "泵式霰弹枪！");
	g_smModelToName.SetString("models/w_models/weapons/w_pumpshotgun_a.mdl", "库洛姆霰弹枪！");
	g_smModelToName.SetString("models/w_models/weapons/w_smg_uzi.mdl", "冲锋枪！");
	...
	g_smModelToName.SetString("models/w_models/weapons/w_desert_rifle.mdl", "三连发沙漠步枪！");
	g_smModelToName.SetString("models/w_models/weapons/w_shotgun_spas.mdl", "战斗霰弹枪！");
	g_smModelToName.SetString("models/w_models/weapons/w_autoshot_m4super.mdl", "半自动霰弹枪！");
	...
	g_smModelToName.SetString("models/w_models/weapons/50cal.mdl", ".50口径机关枪在这儿！");
	g_smModelToName.SetString("models/w_models/weapons/w_minigun.mdl", "微型机关枪在这儿！");
	g_smModelToName.SetString("models/props/terror/exploding_ammo.mdl", "爆炸弹药！");
	g_smModelToName.SetString("models/props/terror/incendiary_ammo.mdl", "燃烧弹药！");
	...
	g_smModelToName.SetString("models/weapons/melee/w_shovel.mdl", "铁锹！");
	...
	g_smModelToName.SetString("models/infected/hunter.mdl", "猎人1");
	...
	g_smModelToName.SetString("models/infected/charger.mdl", "牛！");
